...
function initSearchBar() {
    ...
    $(".search-input").keyup(function () {
        ...
        citiesResults = sortedLocations.filter(location => {
            return !location.hidden && ( location.type !== "base" && location.type !== "hospital" && !location.pointName.includes('מוזיאון') && !location.pointName.includes('בסיס') &&  !location.pointName.includes('תצפית למטס')) && location.pointName.includes(searchInput)
        });
