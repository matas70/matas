    ...
    if (userLoc) {
      ...
      if (haversineDistance(userLoc, currentLocation) < 3) {
        ...
        if ($("#myModal:hidden") && $("#gottoVoiceMessagePopup:hidden")) {
          //timeCount = 0;
          name = aircraft.name;
          let audioMessage = audioMessages[aircraft.aircraftId]
            ? audioMessages[aircraft.aircraftId]
            : audioMessages["default"];
          ...
          if (aircraft.aircraftTypeId === 25) {
            ...
            $("#voiceMessageImg").attr(
              "src",
              "icons/voiceMessage/dictation_glyph.png"
            );
          ...
          if (aircraft.icon) {
            $("#aircraftImg").attr(
              "src",
              `icons/aircrafts/${aircraft.icon}.svg`
            );
          } else {
