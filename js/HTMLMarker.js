...
HTMLMarker.prototype.draw = function () {
  ...
  var panes = this.getPanes();
  this.div.style.left =
    Math.round(position.x - this.div.offsetWidth / 2) + "px";
  this.div.style.top =
    Math.round(position.y - this.div.offsetHeight / 2) + "px";
  this.clickableDiv.style.left =
    Math.round(position.x - this.clickableDiv.offsetWidth / 2) + "px";
  this.clickableDiv.style.top =
    Math.round(position.y - this.clickableDiv.offsetHeight / 2) + "px";
};
