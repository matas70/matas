(function () {
  ...
  var questions = [
    ...
    {
      "title": "איזה כלי מפעילה טייסת 200?",
      "a": "כטמ\"מ השובל (הרון 1)",
      "b": "מטוס הסופה (f16i)",
      "c": "כטמ\"מ האיתן (הרוןTP)",
      "correct": "א",
      "category": "כללי"
    },
    {
      "title": "היכן שירת רן דנקר?",
      "a": "כטכנאי מסוקים בסיס פלמחים",
      "b": "כסייר אוויר בבסיס חצור",
      "c": "כחוקר מודיעין אוויר בקריה",
      "correct": "א",
      "category": "כללי"
    },
    {
      "title": "כיצד קוראים לשלב הראשון בקורס-טיס?",
      "a": "שלב המכין",
      "b": "שלב ראשוני",
      "c": "שלב יסודות",
      "correct": "א",
    ...
    {
      "title": "איזה בסיס של חיל האוויר משמש גם כשמורת טבע?",
      "a": "בסיס פלמחים",
      "b": "בסיס חצור",
      "c": "בסיס עובדה",
      "correct": "א",
    ...
    {
      "title": "מי טבע את הסיסמה: 'הטובים לטיס'?",
      "a": "עורך בטאון חיל האוויר דאז - משה הדר",
      "b": "מפקד חיל האוויר - עזר וויצמן",
      "c": "מפקד חיל האוויר - דוד עברי",
      "correct": "א",
      "category": "כללי"
    },
    {
      "title": "איזה מסוק הדרכה עתיד להחליף את מסוק ה-'סייפן'?",
      "a": "מסוק העופר",
      "b": "מסוק הלהטוט",
      "c": "מסוק ההוקינג",
      "correct": "א",
    ...
    {
      "title": "מי הייתה הטייסת שהצניחה כוחות בקרב המתלה?",
      "a": "רוני צוקרמן",
      "b": "אליס מילר ",
      "c": "יעל רום",
      "correct": "ג",
    ...
    {
      "title": "איזה יכולת קיימת אצל מסוקים בלבד?",
      "a": "היכולת לטוס למרחקים",
      "b": "היכולת לטוס נמוך ",
      "c": "יכולת הריחוף",
      "correct": "ג",
      "category": "כללי"
    ...
    {
      "title": "מי ממפקדי חיל האוויר שישמ בתור רמטכ\"ל?",
      "a": "חיים לסקוב ודן חלוץ",
      "b": "דן חלוץ ",
      "c": "דן חלוץ ועזר וויצמן",
      "correct": "א",
      "category": "כללי"
    },
    {
      "title": "מהו הבסיס הדרומי ביותר של חיל האוויר?",
      "a": "בסיס רמון",
      "b": "בסיס עובדה ",
      "c": "בסיס חצור",
      "correct": "ב",
    ...
    {
      "title": "מה צבע הסרבל של בקרי האוויר?",
      "a": "צהוב",
      "b": "כחול כהה ",
      "c": "ירוק כהה",
      "correct": "ב",
    ...
    {
      "title": "באיזו מלחמה מטוסים עיראקים הפציצו את כפר סבא?",
      "a": "מלחמת ששת הימים",
      "b": "מלחמת ההתשה ",
      "c": "מלחמת המפרץ",
      "correct": "א",
    ...
    {
      "title": "מדוע נאלץ אילן רמון לעזוב את קורס הטיס?",
      "a": "שבר את ידו לאחר שמונה חודשים",
      "b": "התווכח עם המפקד הממונה עליו ",
      "c": "לא עבר את הצ'קים",
      "correct": "א",
      "category": "כללי"
    },
    {
      "title": "מה פשר המונח: 'נגר'?",
      "a": "אדם שלא מפסיק לדבר",
      "b": "אדם ללא כשרון טבעי לטוס ולשלוט בסטיק ",
      "c": "אדם שעושה את הפעולה ביסודיות ושיטתיות",
      "correct": "ב",
      "category": "כללי"
    },
    {
      "title": "מי היה מפקד חיל האוויר בזמן מלחמת יום הכיפורים?",
      "a": "בני פלד",
      "b": "מרדכי הוד",
      "c": "דן טולקובסקי",
      "correct": "א",
