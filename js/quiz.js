(function () {
  ...
  questions.forEach(
    (q) =>
      (q.category = {
        כללי: ["כללי", "כללי2", "כללי3"],
        "מלחמות ישראל": ["מלחמות ישראל", "מלחמות ישראל2", "מלחמות ישראל3"],
        "מטוסי קרב": ["מטוס קרב 1", "מטוסי קרב 2"],
        'הגנ"א': ["הגנא"],
        "יחידות מיוחדות": [
          "יחידות מיוחדות 1",
          "יחידות מיוחדות 2",
  ...
  $(".quiz.button, #quiz .finished .again, .new-popup .quiz").on(
    "click",
    function () {
  ...
  function showNextQuestion() {
    ...
    setTimeout(
      () => $("#quiz .question .option").css({ display: "block" }),
      10
    );
    ...
    $("#quiz .cover").css({
      "background-image": `url('/icons/quiz/pictures/${
        question.category.sort(() => Math.random() - 0.5)[0]
      }.jpg')`,
    });
